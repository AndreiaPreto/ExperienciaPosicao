...
export const mapeamentoQuestions = [
  ...
  // ─── 01 — PONTO DE PARTIDA: O QUE ESTÁ PESANDO ───────────────
  {
    id: 1,
    grupo: "abertura",
    ...
    opcoes: [
      ...
      {
        texto: "Uma tensionamento constante — como se eu estivesse sempre em alerta, esperando o próximo problema",
  ...
  // ─── 02 — MEDO: QUAL É A COR DO SEU MEDO ────────────────────
  {
    id: 2,
    grupo: "medo",
  ...
  // ─── 03 — MENTE: O QUE ACONTECE LÁ DENTRO ───────────────────
  {
    id: 3,
    grupo: "mente",
  ...
  // ─── 05 — DECISÕES: COMO VOCÊ NAVEGA O INCERTO ───────────────
  {
    id: 5,
    grupo: "incerteza",
  ...
  // ─── 06 — ENERGIA: DE ONDE VEM E PARA ONDE VAI ───────────────
  {
    id: 6,
    grupo: "energia",
  ...
  // ─── 07 — RELAÇÕES: O QUE VOCÊ SENTE COM OS OUTROS ──────────
  {
    id: 7,
    grupo: "relacoes",
    ...
    opcoes: [
      ...
      {
        text: "Necessidade de ser vista e ouvida — fico mal quando sinto que ninguém percebe o que estou vivendo",
  ...
  // ─── 08 — EMOÇÕES DIFÍCEIS: O QUE VOCÊ FAZ COM ELAS ─────────
  {
    id: 8,
    grupo: "sombra",
    pergunta: "Quando uma emoção difícil aparece — raiva, tristeza, frustração — qual é a sua resposta mais honesta?",
    opcoes: [
      {
  ...
  // ─── 09 — AUTOESTIMA: COMO VOCÊ SE TRATA ────────────────────
  {
    id: 9,
    grupo: "autoestima",
  ...
  // ─── 11 — LIMITES: ONDE VOCÊ CEDE ───────────────────────────
  {
    id: 11,
    grupo: "limites",
    pergunta: "Quando pensa nos seus limites — com o trabalho, as pessoas, as situações — o que você percebe?",
    opcoes: [
      {
