...
export const fallbackJunho2026: Ciclo[] = [
  ...
  },
  {
    ...
    importancia: "Desapegar não é perder — é criar espaço para o que está vindo. Sem esse esvaziamento, o novo não encontra lugar.",
  ...
  },
  {
    ...
    mes_ano:     "2026-06",
    descricao:   "Ritual para ressignificar seus vínculos afetivos a partir do amor próprio. Não é um ritual de conquista — é de alinhamento: quando você se posiciona com mais presença, seus relacionamentos mudam junto.",
