...
export const ARCANOS_MATRIZ: ArcanoData[] = [
  ...
  },
  {
    ...
    ferida: "Usa o poder externo para compensar segurança interna",
    direcao: "Seu poder grows quando sua ação nasce da presença, não da pressa.",
  ...
  },
  {
    ...
    dom: "Estrutura, direção, leadership, ordenamento e estabilidade.",
  ...
  },
  {
    ...
    mensagem: "Você age, e isso é um dom. Mas sua energia está tão voltada para fora que você perdeu contato com o que está dentro. A velocidade que você usa para avançar é a mesma que usa para não sentir. Quando você para e olha para dentro, a direção fica clara.",
  ...
  },
  {
    ...
    mensagem: "Há uma corrente que você mesma pode soltar, mas ainda não quer. O Diabo não é uma força externa, é a parte de você que prefere o conhecido doloroso ao desconhecido libertador. Reconhecer que a corrente está solta é o primeiro passo para escolher tirá-la.",
